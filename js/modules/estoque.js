...
window.Modules.estoque = {
  ...
  CATEGORIAS: [
    "Colírios",
    "Materiais Cirúrgicos Oftálmicos",
      ...
      <div class="page-content">
        <div class="module-header">
          <h1 class="module-title">
            <i data-lucide="boxes" width="24" height="24" aria-hidden="true"></i>
            Estoque
          </h1>
          <p class="module-subtitle">Controle de materiais e insumos oftalmológicos</p>
        </div>

        <!-- Formulário de cadastro -->
        <div class="card mb-3">
          <div class="card-header">
            <span class="card-title" id="est-form-titulo">Novo Item</span>
          </div>
          <form id="form-estoque" novalidate>
            <input type="hidden" id="est-id">
            <div class="form-grid">
              <div class="form-group">
                <label class="form-label required" for="est-nome">Nome do Item</label>
                <input type="text" id="est-nome" class="form-input" required maxlength="120">
              </div>
              <div class="form-group">
                <label class="form-label required" for="est-categoria">Categoria</label>
                <select id="est-categoria" class="form-select" required>
              ...
              <div class="form-group">
                ...
                <input type="text" id="est-unidade" class="form-input" maxlength="20" placeholder="un, cx, fr...">
              </div>
              <div class="form-group">
                <label class="form-label required" for="est-qtd">Quantidade Atual</label>
                <input type="number" id="est-qtd" class="form-input" min="0" required value="0">
              </div>
              <div class="form-group">
                <label class="form-label required" for="est-minimo">Estoque Mínimo</label>
                <input type="number" id="est-minimo" class="form-input" min="0" required value="0">
              </div>
              <div class="form-group">
                <label class="form-label" for="est-obs">Observações</label>
                <input type="text" id="est-obs" class="form-input" maxlength="200">
              </div>
            </div>
            <div class="form-actions">
              <button type="button" class="btn btn-secondary" id="est-btn-cancelar" style="display:none">Cancelar</button>
        ...
        <div class="filter-bar mb-2">
          <input type="text" id="est-busca" class="filter-input" placeholder="Buscar por nome..." aria-label="Buscar no estoque">
          <select id="est-filtro-cat" class="filter-input" aria-label="Filtrar por categoria">
            <option value="">Todas as categorias</option>
            ${this.CATEGORIAS.map((c) => `<option value="${c}">${c}</option>`).join("")}
          </select>
          <select id="est-filtro-status" class="filter-input" aria-label="Filtrar por status">
        ...
        <div class="table-container">
          <div class="table-toolbar">
            <span class="table-toolbar-title">Itens em Estoque</span>
            <div class="table-actions" id="est-acoes-tabela"></div>
          </div>
          <div class="table-scroll table-mobile-cards">
            <table class="data-table" id="tabela-estoque" aria-label="Estoque">
              <thead>
                <tr>
          ...
          <div id="est-paginacao" class="pagination-bar"></div>
        </div>
      </div>
    `;
